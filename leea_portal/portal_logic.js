...
function applyTranslations() {
    ...
    const cardBotProfile = document.getElementById('cardBotProfile');
    if (cardBotProfile) cardBotProfile.childNodes[0].nodeValue = (t.cardBotProfile || 'Profil Bot Utama:') + " ";
    
    const btnUpdateBot = document.getElementById('btnUpdateBot');
    if (btnUpdateBot) btnUpdateBot.innerText = t.btnUpdateBot || 'Simpan';
